...
export default {
  ...
  "i18n.locale.setting.help": "Only affects Codex-Momery panel text, notices, and status messages. It does not translate chat content, memory nodes, or prompts.",
  ...
  "notice.generic": "Codex-Momery",
  "notice.loading": "{stage} in progress…",
  "notice.partial": "{stage} partially succeeded",

  "panel.entry.floatingTooltip": "Codex-Momery",
  "panel.entry.menuLabel": "Codex-Momery",
  "panel.entry.openPanelAction": "Open Panel",
  "panel.entry.openConsoleAction": "Open Console",
  "panel.entry.openFailed": "Codex-Momery panel failed to load. Check the console for details.",
  "panel.entry.preloadFailed": "Codex-Momery panel preloading failed. Try opening it from the menu again later.",
  "panel.appearance.locale.subtitle": "Only changes the Codex-Momery frontend UI. It does not translate chat content, memory nodes, or prompts.",
  ...
  "panel.sidebar.configTitle": "Codex-Momery Settings",
  ...
  "panel.sidebar.taskTitle": "Codex-Momery Task Flow",
  ...
  "panel.configWorkspace.title": "Codex-Momery Config Workspace",
  ...
  "panel.configSection.plannerDesc": "Intercepts before sending and calls the planning LLM, collecting context from character cards, world books, Codex-Momery memory, and history plots to generate plot and note tags appended to your input.",
  ...
  "panel.taskWorkspace.title": "Codex-Momery Task Flow Workspace",
  ...
  "panel.toggles.wiFilterKeywordsPlaceholder": "Comma-separated, e.g.: Codex-Momery,mvu,test",
  ...
  "panel.cleanup.deleteAllIdb": "Clear All Codex-Momery Local Storage",
  ...
  "theme.crimson.desc": "Dark neutral surfaces with muted violet focus, aligned with the compact Codex-Outfit workbench.",
  ...
  "stage.recall": "Recall",
  "stage.vector": "Vector",
  "stageNotice.title.extraction": "Codex-Momery Extraction",
  "stageNotice.title.generic": "Codex-Momery",
  "stageNotice.title.history": "Codex-Momery History Recovery",
  "stageNotice.title.recall": "Codex-Momery Recall",
  "stageNotice.title.vector": "Codex-Momery Vector",
  ...
  "llm.providerHelp.auto": "Leave blank to reuse the current chat model. Codex-Momery can detect OpenAI-compatible endpoints, Anthropic Claude, and Google AI Studio / Gemini; full endpoints are normalized into reusable base URLs.",
  ...
  "planner.llmPreset.switchedToGlobal": "Switched to follow the current chat model",
  ...
  "authority.mode.standalone.meta": "No server-side enhancement detected; Codex-Momery will continue running locally",
  "authority.mode.standalone.disabled.meta": "Server-side enhancement is disabled; Codex-Momery will continue running locally",
  ...
  "authority.mode.enhanced.meta.noManifest": "Graph and vector storage enhanced; awaiting Codex-Momery vector manifest capability",
