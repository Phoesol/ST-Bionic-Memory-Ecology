...
export default {
  ...
  "i18n.locale.setting.help": "只影响 Codex-Momery 面板、提示和状态文案，不会翻译聊天内容、记忆节点或提示词。",
  ...
  "panel.entry.openConsoleAction": "打开控制台",
  "panel.entry.openFailed": "记忆图谱面板加载失败，请查看控制台报错",
  "panel.entry.preloadFailed": "记忆图谱面板预加载失败，可稍后重试点击菜单",
  "panel.appearance.locale.subtitle": "只切换 Codex-Momery 前端界面，不翻译聊天内容、记忆节点或提示词。",
  ...
  "panel.sidebar.configTitle": "Codex-Momery 设置",
  "panel.sidebar.configHelp": "左侧切换配置页，右侧查看对应的完整设置表单。",
  "panel.sidebar.taskKicker": "任务监控",
  "panel.sidebar.taskTitle": "Codex-Momery 任务流",
  ...
  "panel.configWorkspace.title": "Codex-Momery 配置工作区",
  ...
  "panel.configSection.plannerDesc": "发送前自动拦截并调用规划 LLM，从角色卡、世界书、Codex-Momery 记忆、历史 plot 中收集上下文，生成 plot 和 note 追加到你的输入。",
  ...
  "panel.taskWorkspace.title": "Codex-Momery 任务流工作区",
  ...
  "panel.toggles.wiFilterKeywordsPlaceholder": "用逗号分隔，如：Codex-Momery,mvu,测试",
  ...
  "panel.cleanup.deleteAllIdb": "清空全部 Codex-Momery 本地存储",
  ...
  "theme.crimson.desc": "暗色中性底、紫灰强调，贴近 Codex-Outfit 的紧凑工具台风格。",
  ...
  "stage.recall": "召回",
  "stage.vector": "向量",
  "stageNotice.title.extraction": "Codex-Momery 提取",
  "stageNotice.title.generic": "Codex-Momery",
  "stageNotice.title.history": "Codex-Momery 历史恢复",
  "stageNotice.title.recall": "Codex-Momery 召回",
  "stageNotice.title.vector": "Codex-Momery 向量",
  ...
  "planner.llmPreset.switchedToGlobal": "已改为跟随当前聊天模型",
  ...
  "authority.mode.standalone.meta": "未检测到可用服务端增强，Codex-Momery 将继续本地运行",
  "authority.mode.standalone.disabled.meta": "服务端增强已关闭，Codex-Momery 将继续本地运行",
  ...
  "authority.mode.enhanced.meta.noManifest": "图谱与向量存储已增强，等待 Codex-Momery 向量清单能力",
