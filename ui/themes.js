...
export const THEMES = {
    crimson: {
        name: 'Codex-Outfit',
        primary: '#7c6daf',
        primaryDim: 'rgba(124, 109, 175, 0.10)',
        primaryGlow: 'rgba(124, 109, 175, 0.22)',
        primaryText: '#ffffff',
        secondary: '#9b82f6',
        accent2: '#62d6a2',       // tertiary / success
        accent3: '#d7a84f',       // warning / P1
        surface: '#16161a',
        surfaceContainer: '#1e1e24',
        surfaceHigh: 'rgba(127, 127, 127, 0.08)',
        surfaceHighest: 'rgba(127, 127, 127, 0.14)',
        surfaceLow: '#18181d',
        surfaceLowest: '#121216',
        onSurface: '#eeeeee',
        onSurfaceDim: 'rgba(238, 238, 238, 0.55)',
        border: 'rgba(127, 127, 127, 0.15)',
        borderActive: 'rgba(124, 109, 175, 0.72)',
        // 节点颜色
        nodeCharacter: '#d689bd',
        nodeEvent: '#8eb8ff',
        nodeLocation: '#7ed7ac',
        nodeThread: '#e7c36c',
        nodeRule: '#b6a4ef',
        nodeSynopsis: '#c7bdff',
        nodeReflection: '#91d9e8',
    },
    cyan: {
        name: 'Neon Cyan',
        primary: '#00e5ff',
